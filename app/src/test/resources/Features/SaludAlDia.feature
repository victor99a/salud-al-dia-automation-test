Feature: Pruebas de funcionalidad del portal privado paciente de Salud Al Día
  ...
  # ¿QUÉ ES ESTE ARCHIVO? (.feature)
  # Este archivo utiliza la sintaxis Gherkin para describir el PASO A PASO del caso de
  # prueba en lenguaje natural. Su objetivo es:
  # 1. Documentar el comportamiento esperado del sistema (Salud Al Día).
  # 2. Servir como guía de pasos que luego serán "mapeados" a código Java en los Step Definitions.
  # 3. Facilitar la comunicación entre desarrolladores, QAs y personas no técnicas.
  ...
  Scenario: Validar flujo paciente ingresa a su cuenta registrando sus mediciones exitosamente y obtiene su reporte PDF
    Given navego hasta la siguiente url "https://front-salud-al-dia-production.up.railway.app/"
